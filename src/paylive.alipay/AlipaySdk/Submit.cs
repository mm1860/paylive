...
namespace paylive.alipay.AlipaySdk
{
    ...
    public class Submit
    {
        ...
        static Submit()
        {
            _private_key = Config.merchant_private_key;
            _input_charset = Config.charset.Trim().ToLower();
        ...
        public static string BuildRequest(AopDictionary sParaTemp, string strMethod, string strButtonValue)
        {
