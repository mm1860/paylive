...
namespace paylive.wxpay.Services
{
    public class NativePay
    {
        ...
        */
        ...
        public async Task<string> GetPayUrl(string productId)
        {
            Log.Info(GetType().ToString(), "Native pay mode 2 url is producing...");
            ...
            Log.Info(GetType().ToString(), "Get native pay mode 2 url : " + url);
            return url;
        }
